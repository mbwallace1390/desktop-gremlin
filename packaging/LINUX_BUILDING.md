...
then create and push its matching version tag. For version 3.3.0:
...
```sh
sha256sum --check DesktopGremlin-3.3.0-Linux-x64.sha256
tar -xzf DesktopGremlin-3.3.0-Linux-x64.tar.gz
```
