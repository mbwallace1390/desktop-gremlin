...
then create and push its matching version tag. For version 3.3.1:
...
```sh
sha256sum --check DesktopGremlin-3.3.1-Linux-x64.sha256
tar -xzf DesktopGremlin-3.3.1-Linux-x64.tar.gz
```
